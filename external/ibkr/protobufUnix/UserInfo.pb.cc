...
constexpr UserInfo::UserInfo(
  ...
  : whitebrandingid_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , reqid_(0){}
...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_UserInfo_2eproto[1];
...
const uint32_t TableStruct_UserInfo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::protobuf::UserInfo, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::protobuf::UserInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::protobuf::UserInfo, reqid_),
  PROTOBUF_FIELD_OFFSET(::protobuf::UserInfo, whitebrandingid_),
  1,
  0,
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::protobuf::_UserInfo_default_instance_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_UserInfo_2eproto = {
  false, false, 184, descriptor_table_protodef_UserInfo_2eproto, "UserInfo.proto", 
  &descriptor_table_UserInfo_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_UserInfo_2eproto::offsets,
  file_level_metadata_UserInfo_2eproto, file_level_enum_descriptors_UserInfo_2eproto, file_level_service_descriptors_UserInfo_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_UserInfo_2eproto_getter() {
  return &descriptor_table_UserInfo_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_UserInfo_2eproto(&descriptor_table_UserInfo_2eproto);
namespace protobuf {
...
UserInfo::UserInfo(const UserInfo& from)
  ...
  whitebrandingid_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    whitebrandingid_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_whitebrandingid()) {
    whitebrandingid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, from._internal_whitebrandingid(), 
...
inline void UserInfo::SharedDtor() {
  ...
  whitebrandingid_.DestroyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
// @@protoc_insertion_point(message_clear_start:protobuf.UserInfo)
  ...
  if (cached_has_bits & 0x00000001u) {
    whitebrandingid_.ClearNonDefaultToEmpty();
  }
  reqid_ = 0;
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "protobuf.UserInfo.whiteBrandingId"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:protobuf.UserInfo)
  ...
  if (cached_has_bits & 0x00000003u) {
    if (cached_has_bits & 0x00000001u) {
      _internal_set_whitebrandingid(from._internal_whitebrandingid());
    }
    if (cached_has_bits & 0x00000002u) {
      reqid_ = from.reqid_;
    }
...
void UserInfo::InternalSwap(UserInfo* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      ...
      &whitebrandingid_, lhs_arena,
      &other->whitebrandingid_, rhs_arena
  );
...
template<> PROTOBUF_NOINLINE ::protobuf::UserInfo* Arena::CreateMaybeMessage< ::protobuf::UserInfo >(Arena* arena) {
