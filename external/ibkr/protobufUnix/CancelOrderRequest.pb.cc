...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_CancelOrderRequest_2eproto = {
  false, false, 252, descriptor_table_protodef_CancelOrderRequest_2eproto, "CancelOrderRequest.proto", 
  ...
  file_level_metadata_CancelOrderRequest_2eproto, file_level_enum_descriptors_CancelOrderRequest_2eproto, file_level_service_descriptors_CancelOrderRequest_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_CancelOrderRequest_2eproto_getter() {
  return &descriptor_table_CancelOrderRequest_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_CancelOrderRequest_2eproto(&descriptor_table_CancelOrderRequest_2eproto);
namespace protobuf {
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&ordercancel_) - reinterpret_cast<char*>(this)),
