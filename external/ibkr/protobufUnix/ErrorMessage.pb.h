...
inline std::string* ErrorMessage::release_errormsg() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = errormsg_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (errormsg_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
...
inline void ErrorMessage::clear_advancedorderrejectjson() {
  advancedorderrejectjson_.ClearToEmpty();
...
void ErrorMessage::set_advancedorderrejectjson(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 advancedorderrejectjson_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ErrorMessage::_internal_set_advancedorderrejectjson(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  advancedorderrejectjson_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* ErrorMessage::_internal_mutable_advancedorderrejectjson() {
  _has_bits_[0] |= 0x00000002u;
  return advancedorderrejectjson_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* ErrorMessage::release_advancedorderrejectjson() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  auto* p = advancedorderrejectjson_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (advancedorderrejectjson_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
