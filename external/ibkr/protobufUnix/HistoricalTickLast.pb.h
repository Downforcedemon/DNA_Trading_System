...
class HistoricalTickLast final :
 ...
 public:
  ...
  explicit constexpr HistoricalTickLast(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline std::string* HistoricalTickLast::release_size() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = size_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (size_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
...
inline void HistoricalTickLast::clear_specialconditions() {
  specialconditions_.ClearToEmpty();
...
void HistoricalTickLast::set_specialconditions(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000004u;
 specialconditions_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void HistoricalTickLast::_internal_set_specialconditions(const std::string& value) {
  _has_bits_[0] |= 0x00000004u;
  specialconditions_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* HistoricalTickLast::_internal_mutable_specialconditions() {
  _has_bits_[0] |= 0x00000004u;
  return specialconditions_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* HistoricalTickLast::release_specialconditions() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  auto* p = specialconditions_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (specialconditions_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
