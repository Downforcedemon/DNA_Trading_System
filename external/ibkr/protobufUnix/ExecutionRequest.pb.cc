...
namespace protobuf {
constexpr ExecutionRequest::ExecutionRequest(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : executionfilter_(nullptr)
  , reqid_(0){}
struct ExecutionRequestDefaultTypeInternal {
  constexpr ExecutionRequestDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT ExecutionRequestDefaultTypeInternal _ExecutionRequest_default_instance_;
}  // namespace protobuf
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ExecutionRequest_2eproto = {
  false, false, 258, descriptor_table_protodef_ExecutionRequest_2eproto, "ExecutionRequest.proto", 
  ...
  file_level_metadata_ExecutionRequest_2eproto, file_level_enum_descriptors_ExecutionRequest_2eproto, file_level_service_descriptors_ExecutionRequest_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_ExecutionRequest_2eproto_getter() {
  return &descriptor_table_ExecutionRequest_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_ExecutionRequest_2eproto(&descriptor_table_ExecutionRequest_2eproto);
namespace protobuf {
...
void ExecutionRequest::clear_executionfilter() {
  if (executionfilter_ != nullptr) executionfilter_->Clear();
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&executionfilter_) - reinterpret_cast<char*>(this)),
...
// @@protoc_insertion_point(message_clear_start:protobuf.ExecutionRequest)
  ...
  if (cached_has_bits & 0x00000001u) {
    GOOGLE_DCHECK(executionfilter_ != nullptr);
    executionfilter_->Clear();
  }
  reqid_ = 0;
  _has_bits_.Clear();
...
void ExecutionRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<ExecutionRequest *>(to)->MergeFrom(
      static_cast<const ExecutionRequest &>(from));
}
