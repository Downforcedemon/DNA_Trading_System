...
const uint32_t TableStruct_HistoricalDataBar_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::protobuf::HistoricalDataBar, low_),
  PROTOBUF_FIELD_OFFSET(::protobuf::HistoricalDataBar, close_),
  PROTOBUF_FIELD_OFFSET(::protobuf::HistoricalDataBar, volume_),
  PROTOBUF_FIELD_OFFSET(::protobuf::HistoricalDataBar, wap_),
  PROTOBUF_FIELD_OFFSET(::protobuf::HistoricalDataBar, barcount_),
  0,
  3,
  4,
  5,
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::protobuf::_HistoricalDataBar_default_instance_),
};
...
void HistoricalDataBar::ArenaDtor(void* object) {
  HistoricalDataBar* _this = reinterpret_cast< HistoricalDataBar* >(object);
  (void)_this;
}
void HistoricalDataBar::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
void HistoricalDataBar::InternalSwap(HistoricalDataBar* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(HistoricalDataBar, open_)>(
...
template<> PROTOBUF_NOINLINE ::protobuf::HistoricalDataBar* Arena::CreateMaybeMessage< ::protobuf::HistoricalDataBar >(Arena* arena) {
