...
public:
  ...
  explicit constexpr HistoricalTicksRequest_MiscOptionsEntry_DoNotUse(
...
class HistoricalTicksRequest final :
 ...
 public:
  ...
  explicit constexpr HistoricalTicksRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline std::string* HistoricalTicksRequest::release_startdatetime() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = startdatetime_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
