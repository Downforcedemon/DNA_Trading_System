...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::protobuf::_UnsubscribeFromGroupEventsRequest_default_instance_),
};
...
void UnsubscribeFromGroupEventsRequest::ArenaDtor(void* object) {
  UnsubscribeFromGroupEventsRequest* _this = reinterpret_cast< UnsubscribeFromGroupEventsRequest* >(object);
  (void)_this;
}
void UnsubscribeFromGroupEventsRequest::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
template<> PROTOBUF_NOINLINE ::protobuf::UnsubscribeFromGroupEventsRequest* Arena::CreateMaybeMessage< ::protobuf::UnsubscribeFromGroupEventsRequest >(Arena* arena) {
