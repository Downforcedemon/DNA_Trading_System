...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::protobuf::_CancelScannerSubscription_default_instance_),
};
...
void CancelScannerSubscription::ArenaDtor(void* object) {
  CancelScannerSubscription* _this = reinterpret_cast< CancelScannerSubscription* >(object);
  (void)_this;
}
void CancelScannerSubscription::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
template<> PROTOBUF_NOINLINE ::protobuf::CancelScannerSubscription* Arena::CreateMaybeMessage< ::protobuf::CancelScannerSubscription >(Arena* arena) {
