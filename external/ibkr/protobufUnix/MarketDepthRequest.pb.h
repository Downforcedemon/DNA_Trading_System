...
public:
  ...
  explicit constexpr MarketDepthRequest_MarketDepthOptionsEntry_DoNotUse(
...
class MarketDepthRequest final :
 ...
 public:
  ...
  explicit constexpr MarketDepthRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
