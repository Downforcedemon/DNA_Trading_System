...
class RealTimeBarTick final :
 ...
 public:
  ...
  explicit constexpr RealTimeBarTick(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline std::string* RealTimeBarTick::release_volume() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = volume_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
...
void RealTimeBarTick::set_wap(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 wap_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void RealTimeBarTick::_internal_set_wap(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  wap_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* RealTimeBarTick::_internal_mutable_wap() {
  _has_bits_[0] |= 0x00000002u;
  return wap_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* RealTimeBarTick::release_wap() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  auto* p = wap_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (wap_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
