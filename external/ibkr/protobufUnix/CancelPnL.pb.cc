...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::protobuf::_CancelPnL_default_instance_),
};
...
void CancelPnL::ArenaDtor(void* object) {
  CancelPnL* _this = reinterpret_cast< CancelPnL* >(object);
  (void)_this;
}
void CancelPnL::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
template<> PROTOBUF_NOINLINE ::protobuf::CancelPnL* Arena::CreateMaybeMessage< ::protobuf::CancelPnL >(Arena* arena) {
