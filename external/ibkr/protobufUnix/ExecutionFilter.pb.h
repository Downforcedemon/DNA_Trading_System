...
class ExecutionFilter final :
 ...
 public:
  ...
  explicit constexpr ExecutionFilter(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void ExecutionFilter::set_acctcode(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 acctcode_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ExecutionFilter::_internal_set_acctcode(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  acctcode_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* ExecutionFilter::_internal_mutable_acctcode() {
  _has_bits_[0] |= 0x00000001u;
  return acctcode_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* ExecutionFilter::release_acctcode() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = acctcode_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (acctcode_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    acctcode_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
