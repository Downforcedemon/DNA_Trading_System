...
public:
  ...
  explicit constexpr MarketDataRequest_MarketDataOptionsEntry_DoNotUse(
...
class MarketDataRequest final :
 ...
 public:
  ...
  explicit constexpr MarketDataRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void MarketDataRequest::set_genericticklist(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 genericticklist_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void MarketDataRequest::_internal_set_genericticklist(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  genericticklist_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* MarketDataRequest::_internal_mutable_genericticklist() {
  _has_bits_[0] |= 0x00000001u;
  return genericticklist_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* MarketDataRequest::release_genericticklist() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = genericticklist_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (genericticklist_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
